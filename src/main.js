            ...
            document.getElementById('generate_qr_code_button').addEventListener('click', function() {
                var pix_value = document.getElementById('pix_value').value.toString() + '.00';
                ...
                payload = '00020126360014BR.GOV.BCB.PIX01' + pixlength + pix_key + '52040000530398654' + pix_lengthFormatted + pix_value + '5802BR59' + destinatariolength + destinatario + '60' + cidadelength + cidade + '62130509pixcartao';
